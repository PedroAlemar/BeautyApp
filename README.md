...
Estilizar interfaces com CSS (cores, tipografia, layouts responsivos);
...
Interações básicas com o usuário;

Organização modular do código para melhor entendimento.
...
git clone https://github.com/PedroAlemar/beautyapp.git
